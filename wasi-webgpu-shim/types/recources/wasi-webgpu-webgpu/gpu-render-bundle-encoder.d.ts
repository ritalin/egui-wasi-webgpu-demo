...
import type { GpuIndex32, GpuIndexFormat, GpuRenderBundleDescriptor, GpuSignedOffset32, GpuSize32, GpuSize64 } from "../../types/wasi-webgpu-webgpu.js";
export declare class GpuRenderBundleEncoder {
    private readonly _handle;
    constructor(_handle: peer.GPURenderBundleEncoder);
