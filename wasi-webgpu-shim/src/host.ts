...
import { GpuBindGroupLayout, GpuDevice } from "./recources/wasi-webgpu-webgpu";
import { TextureFormat } from "./supports/enum-conv";
import SHADER_SOURCE from "./shader.wgsl.js";
...
export class WebGpuRuntime {
  ...
  createRenderContext(canvas: HTMLCanvasElement): RenderContext {
    ...
    const context = new RenderContext(peer);
